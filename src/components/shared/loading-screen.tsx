...
export function LoadingScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-1/2 h-[34rem] w-[34rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-400/10 bg-cyan-400/5 blur-3xl" />

      <div className="relative mx-6 w-full max-w-md overflow-hidden rounded-[28px] border border-white/10 bg-white/6 p-8 text-slate-100 shadow-[0_32px_120px_rgba(2,6,23,0.7)] backdrop-blur-2xl">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <div className="mt-6">
            <VertexLogo width={190} height={52} className="mx-auto drop-shadow-[0_12px_34px_rgba(34,211,238,0.24)]" />
          </div>
